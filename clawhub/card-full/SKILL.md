...
American Express, Bank of America, Capital One, Chase, Citi, Discover, Wells Fargo. If the card is from an unsupported issuer, return: "This card is not from a supported issuer."
